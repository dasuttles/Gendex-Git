...
<html>
	...
	<body>
		...
		$raw_results = mysql_query("SELECT * FROM vital_records WHERE (`name_of_deceased` LIKE '%".$query."%') ORDER BY name_of_deceased ASC") or die(mysql_error());
			
		if(mysql_num_rows($raw_results) > 0){ // if one or more rows are returned do following ?>
		<div class="vdthead">
			<a href="href="http://www.valdosta.edu/archives""><img src="../img/vsuasc-logo_f.png" alt="Archive Logo" class="logo"/></a>
			<h1>VDT Obituary Search Results <small><?php echo "for <strong>$query</strong>"; ?> </small></h1>
		...
		<div>
			<table class="table table-striped table-hover table-bordered">
				<tr class="vdttabhead">
					...
					<td><strong>Name of Deceased</strong></td></td>
				...
				<tr>
					<td><?php echo $i; ?></td>
					<td><?php echo $results['name_of_deceased']; ?></td>
