...
<html>
	...
	<body>
		...
		$raw_results = mysql_query("SELECT * FROM vital_records WHERE (`brides_name` LIKE '%".$query."%') OR (`grooms_name` LIKE '%".$query."%') ORDER BY year ASC") or die(mysql_error());
			
		if(mysql_num_rows($raw_results) > 0){ // if one or more rows are returned do following ?>
		<div class="vdthead">
			<a href="href="http://www.valdosta.edu/archives""><img src="../img/vsuasc-logo_f.png" alt="Archive Logo" class="logo"/></a>
			<h1>VDT Weddings Search Results <small><?php echo "for <strong>$query</strong>"; ?> </small></h1>
		...
		<div>
			<table class="table table-striped table-hover">
				<tr class="vdttabhead">
					...
					<td><strong>Bride's Name</strong></td></td>
					<td><strong>Groom's Name</strong></td>
				...
				<tr>
					<td><?php echo $i; ?></td>
					<td><?php echo $results['brides_name']; ?></td>
					<td><?php echo $results['grooms_name']; ?></td>
