...
<html>
	...
	<body>
		...
		$raw_results = mysql_query("SELECT * FROM vital_records WHERE (`groom_to_be` LIKE '%".$query."%') OR (`bride_to_be` LIKE '%".$query."%') ORDER BY groom_to_be ASC") or die(mysql_error());
			
		if(mysql_num_rows($raw_results) > 0){ // if one or more rows are returned do following ?>
		<div class="vdthead">
			<a href="href="http://www.valdosta.edu/archives""><img src="../img/vsuasc-logo_f.png" alt="Archive Logo" class="logo"/></a>
			<h1>VDT Engagements Search Results <small><?php echo "for <strong>$query</strong>"; ?> </small></h1>
		...
		<div>
			<table class="table table-striped table-hover table-bordered">
				<tr class="vdttabhead">
					...
					<td><strong>Groom to Be</strong></td></td>
					<td><strong>Bride to Be</strong></td>
				...
				<tr>
					<td><?php echo $i; ?></td>
					<td><?php echo $results['groom_to_be']; ?></td>
					<td><?php echo $results['bride_to_be']; ?></td>
