...
<title>Valdosta Daily Times Birth Announcements Search Results</title>
</head>

<body>
<h1>Valdosta Daily Times Birth Announcments Search Results</h1><p>
...
$query = "SELECT month, day, year, vol, issue, record_type, page_section, newborns_name, fathers_name, mothers_name, MATCH (newborns_name, mothers_name, fathers_name) AGAINST ('$searchterm') AS score FROM vital_records WHERE MATCH (newborns_name, mothers_name, fathers_name) AGAINST ('$searchterm')";
